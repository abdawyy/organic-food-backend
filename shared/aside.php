    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="blog" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?= url('app/blog/add.php')  ?>">
                        <i class="bi bi-circle"></i><span>Add </span>
                    </a>
                </li>
                <li>
                    <a href="<?= url('app/blog/list.php')  ?>">
                        <i class="bi bi-circle"></i><span>List</span>
                    </a>
                </li>
            </ul>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#mess" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>user message</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="mess" class="nav-content collapse " data-bs-parent="#sidebar-nav">
              
                <li>
                    <a href="<?= url('app/message/list.php')  ?>">
                        <i class="bi bi-circle"></i><span>List</span>
                    </a>
                </li>
            </ul>
