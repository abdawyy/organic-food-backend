...
$selectB="SELECT * FROM `blog` ";
$rowB=mysqli_query($conn,$selectB);
$count=mysqli_num_rows( $rowB );
?>
<!DOCTYPE html>
<html lang="zxx">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="row">
                        <?php foreach($rowB as $r ):?>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                     <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="../app/blog/upload/<?= $r['image']?>" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i><?= $r['date']?> </li>
