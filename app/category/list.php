              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <th scope="row"><?= $items['e-mail'] ?></th>
                    <th scope="row"><?= $items['pass'] ?></th>
                    <th scope="row"><?= $items['mobile'] ?></th>
                    <th scope="row"><?= $items['address'] ?></th>
                    <th scope="row">
                        <a href="?delete=<?= $items['ID']?>" class="btn btn-danger">delete</a>
                        <a href="<?= url("app/category/update.php?edit=") . $items['ID'] ?>" class="btn btn-warning"> edit</a>
                    </th>
                  </tr>
                  <?php endforeach?>
